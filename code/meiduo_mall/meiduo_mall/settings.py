...
SECRET_KEY = '-b$o92dn$3kd)c((j3k009qs!w85z2^ovxag@aa_f30@^yiflk'
...
################## 发送邮件 ############################################
# EMAIL_BACKEND 调用django哪个类去发送邮件
